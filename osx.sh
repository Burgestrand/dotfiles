...
sudo scutil --set ComputerName "Kim's Laptop"
sudo scutil --set HostName "Kim's Laptop"
sudo scutil --set LocalHostName "Kims-Laptop"
...
# this allows updating from System Update, but not executing (i.e. no menu icon)
